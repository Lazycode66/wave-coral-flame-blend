...
//#region node_modules/.nitro/vite/services/ssr/assets/router-7ZsU9hjW.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 max-w-xs rounded-md bg-elevated px-3 py-1.5 text-xs text-fg shadow-[var(--shadow-border)]", className),
	...props
}) }));
TooltipContent.displayName = Content2.displayName;
var styles_default = "/assets/styles-tYbuPU3h.css";
var APP_NAME = "Lantern";
var Route$2 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Check a suspicious link, message, or app. Lantern explains phishing, digital-arrest scams, and greedy permissions — calmly."
			},
			{
				name: "theme-color",
				content: "#0b0c0e"
...
var $$splitComponentImporter$1 = () => import("./routes-BAqkCphT.mjs");
var Route$1 = createFileRoute("/")({
	validateSearch: (search) => ({ sample: typeof search.sample === "string" ? search.sample : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./learn-C_PIuTRn.mjs");
var Route = createFileRoute("/learn")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
