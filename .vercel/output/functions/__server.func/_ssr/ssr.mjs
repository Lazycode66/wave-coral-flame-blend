...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-jdMFXua1.mjs");
...
var manifest = { "48b9a4cb92c2d0c22d8fc07644af6947b499fd0b4578a8e5eb0ec7a9c4e664cb": {
	functionName: "enhanceBriefing_createServerFn_handler",
	importer: () => import("./briefing-DnXr3uUZ.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-7ZsU9hjW.mjs").then((n) => n.t),
